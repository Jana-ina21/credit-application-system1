...
class CreditResourceTest {
    ...
    fun `should create a credit and return 201 status`() {
        ...
        mockMvc.perform(
            ...
            .andExpect(MockMvcResultMatchers.jsonPath("$.emailCustomer").value("jana@email.com"))
    ...
    fun `should not find credit with invalid Credit Code and return 400 status`() {
        //given
        val credit: Credit = creditRepository.save(buildCreditDto().toEntity())
        val invalidCreditCode = "8f56f7fe-2bc7-4bd5-a88e-3a10c30198b1"
        //when
        //then
        mockMvc.perform(
    ...
    private fun builderCustomerDto(
        firstName: String = "Janaina",
        lastName: String = "Silva",
        cpf: String = "62539893082",
        email: String = "jana@email.com",
        income: BigDecimal = BigDecimal.valueOf(1000.0),
        password: String = "1234",
        zipCode: String = "0000000",
        street: String = "Rua de cima, 578",
    ) = CustomerDto(
        firstName = firstName,
        lastName = lastName,
        cpf = cpf,
